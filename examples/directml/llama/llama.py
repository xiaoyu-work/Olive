...
def optimize(model_name: str, optimized_model_dir: Path):
    ...
    olive_config = None
    with open(script_dir / "config_llama.json", "r") as fin:
    ...
    footprints_file_path = Path(__file__).resolve().parent / "footprints/llama_gpu-dml_footprints.json"
...
if __name__ == "__main__":
    ...
    model_to_hidden_size = {
        "decapoda-research/llama-7b-hf": 4096,
    }
