...
def llama_inputs(batch_size, torch_dtype):
...
def llama_data_loader(data_dir, batch_size, *args, **kwargs):
    return RandomDataLoader(llama_inputs, batch_size, torch.float16)
