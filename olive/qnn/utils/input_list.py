...
def create_input_list(
    ...
    append_0: If True, a ":0" is appended to the input names. For some reason, QNN attaches a ":0" to the input and
        output names when converting TensorFlow models to QNN.
